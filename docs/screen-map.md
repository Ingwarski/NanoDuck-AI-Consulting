...
| ST-09 | S-02 | `active` — visible thought bubble/text, minimized composer, separated square Stop, and no in-progress title | `#discussion` · UC-002, UC-003 |
