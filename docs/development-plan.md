...
22 September 2026 · Status: **local refactor and scoped browser/research/provider repairs authorized; implementation evidence remains scoped**. The user explicitly requested this existing application change and confirmed macOS, Linux, Windows and local Wi-Fi/LAN access. This plan governs the current repository and private local data only.
