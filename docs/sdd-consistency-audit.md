...
Current state: Electric A v8 remains the approved visual baseline. The former Fast/Balanced/Thorough/Ultra pace allocation is historical. The current reconciliation replaces it with independent specialist-count (1/2/3/5/Auto) and discussion-depth (1/3/5/Auto) settings, including Head selection of an Auto team and a 10-exchange Auto-depth ceiling. The manifest binds current hashes, the preserved frozen baseline and the renewed Phase 3 prompt receipt. The prior [approved-plan audit receipt](../forge/design/evidence/electric-v8-approved-plan-audit-20260914.json) remains historical evidence for its earlier source set. The owner authorized local Phase 3 work; browser-native voice, owner-only JPEG/PNG/WebP image attachments at most 8 MiB, role/language/source enforcement and the two consultation controls are implemented locally. U-08 now has a source-bound [local-integration receipt](../forge/runs/U-08/phase3-local-integration-preparation-20260914/verification.json) and [non-deploying cutover package](../forge/runs/U-08/phase3-local-integration-preparation-20260914/cutover-package.md), both explicitly non-deploying. They record local memory-store/fake-provider behavior, then one synthetic Ukrainian direct-question smoke test through the actual local Codex app-server, plus configuration and rollback prerequisites without relabelling formal checks as passed. The 82 formal checks and six release gates remain prepared / not_run and release readiness remains not_evaluated; production and GoDaddy operations remain unperformed. U-04 now has a separate source-bound [recipient-topology correction receipt](../forge/runs/U-04/phase3-recipient-topology-correction-20260914/verification.json): deterministic consultation and HTTP seams, plus one actual synthetic local provider run, prove the required Head-task, specialist-to-Critic, Critic-specialist and final-Head routing in their declared scope. Broader provider compliance remains unobserved. U-02 and U-05 still lack separate source-bound implementation receipts, so U-08 does not treat their acceptance as evidenced.
