...
| AC-002 — Useful exchange (UC-002) | Every accepted question produces separate specialist and Critic invocations, a material objection and response/revision. A sound scenario permits reasoned agreement. No single completion can pass as several agents. Head sends only recipient-specific tasks before its final owner synthesis. |
