...
| FR-05.3 | Settings provides specialist count 1/2/3/5/Auto and discussion depth 1/3/5/Auto. Specialist count excludes Head and Critic. Depth counts complete Critic ↔ specialist exchanges per specialist. All selected specialists must be reviewed before synthesis. Auto evaluates agreement only after a complete team review and permits at most 10 exchanges per specialist. The 540,000 ms provider budget remains separate. | UC-005 |
