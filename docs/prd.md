...
| FR-05.3 | Settings provides specialist count 1/2/3/5/Auto and discussion depth 1/3/5/Auto. Specialist count excludes Head and Critic. Depth counts complete Critic ↔ specialist exchanges per specialist. All selected specialists must be reviewed and contribute a closing position before Critic evaluates them together; Head synthesis requires those committed messages. Auto requires specialist agreement and a supporting closing Critic review to stop early; Critic disagreement continues exchanges within the ten-per-specialist cap. Final positions and closing review do not count as additional exchanges. The 540,000 ms provider budget remains separate. | UC-005 |
