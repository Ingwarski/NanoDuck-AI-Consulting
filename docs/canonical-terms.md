...
| Login / Logoff | Exact desktop and mobile menu labels for starting sign-in / ending an authenticated app session. Logoff also applies before first-use consent. | Concurrent Login and Logoff menu actions |
